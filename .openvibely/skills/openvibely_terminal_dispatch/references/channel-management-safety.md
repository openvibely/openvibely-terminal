...
Use this reference when implementing or auditing `/channels` add, edit, disconnect, or remove behavior in `internal/terminal/registry.go` and its interactive/headless regressions.
